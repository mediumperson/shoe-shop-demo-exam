...
"}")
        ...
        self.status_input.addItem("")
        self.gridLayout.addWidget(self.status_input, 4, 0, 1, 1)
...
"    border-color: #00FA9A;\n"
"}")
        self.delivery_date.setDateTime(QtCore.QDateTime(QtCore.QDate(1999, 12, 30), QtCore.QTime(0, 0, 0)))
        self.delivery_date.setCalendarPopup(False)
        self.delivery_date.setObjectName("delivery_date")
        self.gridLayout.addWidget(self.delivery_date, 10, 0, 1, 1)
        ...
        self.pvz_adress = QtWidgets.QComboBox(parent=order_edit)
        self.pvz_adress.setObjectName("pvz_adress")
        self.gridLayout.addWidget(self.pvz_adress, 6, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.date_order, 8, 0, 1, 1)
        ...
        self.label_6 = QtWidgets.QLabel(parent=order_edit)
...
"}")
    ...
    def retranslateUi(self, order_edit):
        ...
        self.label_6.setText(_translate("order_edit", "Редактирование заказа"))
